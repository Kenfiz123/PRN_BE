    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubManagerAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubManagerAssignments_Clubs_ClubId",
                        column: x => x.ClubId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubManagerAssignments_ClubId_ManagerUserId_IsActive",
                table: "ClubManagerAssignments",
                columns: new[] { "ClubId", "ManagerUserId", "IsActive" });
